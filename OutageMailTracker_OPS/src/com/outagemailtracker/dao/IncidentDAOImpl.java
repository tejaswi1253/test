...
public class IncidentDAOImpl implements IncidentDAO{
	...
	public int insertIncident(Incident incident) throws Exception{
		...
		try 
		{
			 ...
			 * ADD
			 */
			inc.setImpact_window(incident.getImpact_window());
			
			inc.setAnnouncement(incident.getAnnouncement());
			//
			System.out.println("incident.getAnnouncement()"+incident.getAnnouncement());
...
//			}
	...
	public Incident getIncidentById(int incId) throws Exception{
		...
		try 
		{
			 ...
			 * ADD
			 */
			inc.setImpact_window(incEntity.getImpact_window());
			inc.setAnnouncement(incEntity.getAnnouncement());

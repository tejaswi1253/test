...
"  </tr>\r\n" + 
	...
	"    <td  style=\"width:390px; border:1px solid green;font-size:85%;padding:5px 5px 5px 5px;\">"+ inc.getIssueType()+"</td> \r\n" + 


"  </tr>\r\n" + 
	"  <tr>\r\n" + 
	"    <td  style=\"width:260px; border:1px solid green;font-size:85%;font-weight:bold;padding:5px 5px 5px 5px;\">Root Cause</td>\r\n" + 
	"    <td  style=\"width:390px; border:1px solid green;font-size:85%;padding:5px 5px 5px 5px;\">"+ inc.getRca()+"</td> \r\n" + 

	
					"  </tr>\r\n" + 
					"  <tr>\r\n" + 
					"    <td  style=\"width:260px; border:1px solid green;font-size:85%;font-weight:bold;padding:5px 5px 5px 5px;\">Impact Window</td>\r\n" + 
					"    <td  style=\"width:390px; border:1px solid green;font-size:85%;padding:5px 5px 5px 5px;\">"+ inc.getImpact_window()+"</td> \r\n" + 
		...
		// This mail has 2 part, the BODY and the embedded image
	         ...
	         String htmlText = "<table max-width=\"650px\" style=\"border:1px solid green; border-collapse:collapse;font-family:Verdana;table-layout:fixed;\">\r\n" + 
			   		...
			   		"  </tr>\r\n" + 
			   			"  <tr>\r\n" + 
			   			"    <td  style=\"width:260px; border:1px solid green;font-size:85%;font-weight:bold;padding:5px 5px 5px 5px;\">Issue Type</td>\r\n" + 
			   			"    <td  style=\"width:390px; border:1px solid green;font-size:85%;padding:5px 5px 5px 5px;\">"+ res.getIssueType()+"</td> \r\n" + 


			   		"  </tr>\r\n" + 
			   			"  <tr>\r\n" + 
			   			"    <td  style=\"width:260px; border:1px solid green;font-size:85%;font-weight:bold;padding:5px 5px 5px 5px;\">Root Cause</td>\r\n" + 
			   			"    <td  style=\"width:390px; border:1px solid green;font-size:85%;padding:5px 5px 5px 5px;\">"+ res.getRca()+"</td> \r\n" + 
...
//		   message.setContent(htmlContent,"text/html");
	    ...
	    */
		...
		public String announcementMailSend(Incident inc) throws Exception {
			   String output="";
			  String to = inc.getTo();
			  String from = inc.getFrom();
			  final String username = "";//change accordingly
	...
	"  </tr>\r\n" + 
		...
		"    <td  style=\"width:390px; border:1px solid green;font-size:85%;padding:5px 5px 5px 5px;\">"+ inc.getAnnouncement()+"</td> \r\n" + 
						"  </tr>\r\n" + 
						"  <tr>\r\n" + 
						"    <td  style=\"width:260px; border:1px solid green;font-size:85%;font-weight:bold;padding:5px 5px 5px 5px;\">Contact Team</td>\r\n" + 
						"    <td  style=\"width:390px; border:1px solid green;font-size:85%;padding:5px 5px 5px 5px;\">"+inc.getContactTeam()+"</td> \r\n" + 
				 ...
				 MimeBodyPart imagePart = new MimeBodyPart();
				 ClassLoader classLoader = Test.class.getClassLoader();
				 File f=new File(classLoader.getResource("AnnouncementNotificationHeader.JPG").getFile());
				 imagePart.attachFile(f);
				 imagePart.setContentID("<" + cid + ">");
				 imagePart.setDisposition(MimeBodyPart.INLINE);
				 multipart.addBodyPart(imagePart);
